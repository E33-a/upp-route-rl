...
\begin{figure}[H]
	...
	\IfFileExists{img/fig1_regresion_lineal.png}{%
		\includegraphics[width=0.7\textwidth]{img/fig1_regresion_lineal.png}%
	}{%
		\begin{tcolorbox}[colback=purpleUPP!5!white,colframe=purpleUPP,title={Gráfico en Espera}]
			\centering \textit{La gráfica ajustada ($Y = a + b X$) se generará al ejecutar el script \texttt{02\_train\_regression.py}.}
		\end{tcolorbox}%
	}%
