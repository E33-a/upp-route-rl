...
\textbf{Qué decir en voz alta:}
``Gracias Ximena. La ecuación estimada obtenida fue $\widehat{Y} = 14.4168 - 2.6306 \cdot X$, con un coeficiente de determinación $R^2 = 0.1452$ (14.52\% variancia explicada). Esto significa que si no hay nadie en cola al llegar ($X=0$), la espera esperada es de 14.42 minutos. Además, por cada alumno ya formado en cola, el tiempo de espera disminuye en 2.63 minutos. El p-valor extremadamente pequeño ($2.07 \times 10^{-67}$) confirma una alta significancia estadística.''
